...
Route::domain(config('domains.app'))->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::post('/email/resend', function (\Illuminate\Http\Request $r) {
            ...
            Route::middleware('tenant')->group(function () {
                ...
                Route::middleware('addon:agent-ai')->group(function () {
                    ...
                    Route::get('/projects/{project}/chats/{chat}/agent/{agentRun}/steps',
                        [AgentController::class, 'steps'])->name('agent.steps');
                ...
                Route::get('/projects/{project}/chats/{chat}/export/pdf',
                    [ExportController::class, 'exportPdf'])->name('chats.export.pdf');
