...
<template>
    <div class="min-h-screen flex" :style="vars" style="background:var(--app-bg);color:var(--text)">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <!-- Logo -->
            <div class="flex items-center gap-3 px-5 py-5 shrink-0" style="border-bottom:1px solid var(--sb-border)">
                <div class="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 overflow-hidden" style="background:var(--brand)">
            ...
            <nav class="px-3 pt-4 pb-2 space-y-0.5 shrink-0">
                ...
                <!-- Settings — with lock badge for members -->
